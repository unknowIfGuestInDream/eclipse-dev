 ...
 *******************************************************************************/
package com.tlcsdm.examples.swt.snippets;
...
public class Snippet135 {
    ...
    public static void main(String[] args) {
        ...
        Frame locationFrame = SWT_AWT.new_Frame(locationComp);
        final TextField locationText = new TextField();
        locationFrame.add(locationText);

        Frame fileTableFrame = SWT_AWT.new_Frame(tableComp);
        ...
        Frame statusFrame = SWT_AWT.new_Frame(statusComp);
