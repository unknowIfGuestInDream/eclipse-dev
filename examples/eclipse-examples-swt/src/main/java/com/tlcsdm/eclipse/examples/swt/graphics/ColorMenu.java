...
public class ColorMenu {
     ...
     * the menu.
     *
     * @param enable A boolean flag - true to make the color menu items visible in
     ...
     * in the menu.
     *
     * @param enable A boolean flag - true to make the pattern menu items visible
     ...
     * in the menu.
     *
     * @param enable A boolean flag - true to make the gradient menu items visible
     *               in the menu; false otherwise.
     */
     ...
     * @param name      The path of the image file
     * @param resources The list of resources of the menu
     */
